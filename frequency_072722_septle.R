...
word_list <- read.table("C:/Users/drsin/OneDrive/Documents/R Projects/wordle/seven_letter_words2.txt", sep = "\n")
...
#normalized
#there are 28 spaces in char_freq which I am just going to subset out, but I need
#to track down the source
#char_frequencies<- char_frequencies[2:27, ]
...
ggplot(char_frequencies, aes(x= letter_order, y )) +
  geom_col()+
...
num_words <- nrow(word_list)  #I should read this in
#num_words <- 5
